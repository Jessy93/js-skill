...
function stringTimerCounter() {
  let seconds = (timerCount % 60).toString().length === 1 ? '0' + (timerCount % 60) : (timerCount % 60);
  let minutes = (Math.floor(timerCount / 60) % 60).toString().length === 1 ? '0' + (Math.floor(timerCount / 60) % 60) : (Math.floor(timerCount / 60) % 60);
  let hours = (Math.floor(timerCount / 60 / 60)).toString().length === 1 ? '0' + (Math.floor(timerCount / 60 / 60)) : (Math.floor(timerCount / 60 / 60));
